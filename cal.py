...
ak2 = Button(root,text="√",padx=29,pady=20, command=akar)
sisa = Button(root,text="%",padx=28,pady=20, command=sisabagi)
pang = Button(root,text="x²",padx=28,pady=20, command=pangkat)

tam = Button(root,text="+",padx=30,pady=20, command=tambah)
kur = Button(root,text="-",padx=31,pady=20, command=kurang)
kal = Button(root,text="x",padx=30,pady=20, command=kali)
bag = Button(root,text="/",padx=30,pady=20, command=bagi)
hap = Button(root,text="C",padx=29,pady=20, command=hapus)
sam = Button(root,text="=",padx=30,pady=20, command=samadengan)
des = Button(root,text=".",padx=30,pady=20, command=lambda:angka("."))
...
des.grid(row=5,column=2,pady=2)

ak2.grid(row=4,column=0,pady=2)
